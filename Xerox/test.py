...
clf = AdaBoostClassifier(base_estimator = DecisionTreeClassifier(min_samples_split = 3 , min_samples_leaf =3) , n_estimators=210) 
#print 'Doing with min_samples_leaf =' , leaf , 'and no. of n_estimators =' , ne
...
for i in range(min_id_test , max_id_test + 1):
    ...
    for j,row in current_patient_df_test.iterrows():
        ...
        #input feature vector for our classifier model
            ...
            output.append([int(row[0]) , int(row[1]) , y_predicted_test])
