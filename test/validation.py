...
def get_predicted_labels_and_median_time():
    output_df = pd.read_csv('output_val.csv')
...
for ne in [50 , 75 , 100 , 125 ,150 ,175 ,200]:
    ...
    for leaf in range(1,4):
        ...
        for m_samples_split in range(2,5):
            ...
            clf = AdaBoostClassifier(base_estimator = DecisionTreeClassifier(min_samples_split=m_samples_split,  min_samples_leaf =leaf) , n_estimators=ne) 
            ...
            wr  = csv.writer(open('output_val.csv' , 'w+'))
